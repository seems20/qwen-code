...
```bash
npm install @rdmind/sdk-typescript
```
...
```typescript
import { query } from '@rdmind/sdk-typescript';
...
```typescript
import { query, type SDKUserMessage } from '@rdmind/sdk-typescript';
...
```typescript
import { query, type CanUseTool } from '@rdmind/sdk-typescript';
...
```typescript
import { query, isAbortError } from '@rdmind/sdk-typescript';
...
```typescript
import { AbortError, isAbortError } from '@rdmind/sdk-typescript';
