...
// Chinese translations for RDMind CLI
...
export default {
  ...
  'for help on RDMind': '获取 RDMind 帮助',
  ...
  // ============================================================================
  'Project Level (.rdmind/agents/)': '项目级 (.rdmind/agents/)',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run RDMind in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 RDMind：VS Code 或 VS Code 分支版本。',
  ...
  // Commands - Summary
  // ============================================================================
  'Generate a project summary and save it to .rdmind/PROJECT_SUMMARY.md':
    '生成项目摘要并保存到 .rdmind/PROJECT_SUMMARY.md',
  ...
  'Remove directories from the workspace. Use comma to separate multiple paths':
    '从工作区移除目录。使用逗号分隔多个路径',
  'Please provide at least one path to remove.': '请提供至少一个要移除的路径。',
  'The /directory remove command is not supported in restrictive sandbox profiles. Please use --include-directories when starting the session instead.':
    '/directory remove 命令在限制性沙箱配置文件中不受支持。请改为在启动会话时使用 --include-directories。',
  "Error removing '{{path}}': {{error}}": "移除 '{{path}}' 时出错：{{error}}",
  ...
  'A new version of RDMind is available! {{currentVersion}} → {{latestVersion}}':
    '发现新版本 RDMind！{{currentVersion}} → {{latestVersion}}',
  'RDMind update available! {{currentVersion}} → {{latestVersion}}':
    'RDMind 更新可用！{{currentVersion}} → {{latestVersion}}',
