...
import { createDebugLogger, isGitRepository } from '@rdmind/rdmind-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @rdmind/rdmind@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @rdmind/rdmind@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @rdmind/rdmind@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @rdmind/rdmind@latest';
    return {
