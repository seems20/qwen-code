...
import type { DiscoveredMCPPrompt } from '@rdmind/rdmind-core';
import {
  DiscoveredMCPTool,
...
const authCommand: SlashCommand = {
  name: 'auth',
  description: '向支持 OAuth 的 MCP 服务认证',
  ...
  action: async (
    ...
    try {
      ...
      const { MCPOAuthProvider } = await import('@rdmind/rdmind-core');
