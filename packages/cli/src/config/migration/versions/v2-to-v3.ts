...
export class V2ToV3Migration implements SettingsMigration {
  ...
  migrate(
    ...
    // Step 3: Migrate context.fileFiltering.respectQwenIgnore to respectRdmindIgnore
    ...
    if (
      ...
      deleteNestedPropertySafe(result, qwenIgnorePath);
      setNestedPropertySafe(result, rdmindIgnorePath, qwenIgnoreValue);
    }

    // Step 4: Always update version to 3
    result['$version'] = 3;
