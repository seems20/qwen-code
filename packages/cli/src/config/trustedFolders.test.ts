...
import { FatalConfigError, ideContextStore } from '@rdmind/rdmind-core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use RDMIND_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['RDMIND_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['RDMIND_TRUSTED_FOLDERS_PATH'];
  });
