/**
 * @license
 * Copyright 2025 RDMind Code
 * SPDX-License-Identifier: Apache-2.0
 */

import { vi, describe, it, expect, beforeEach, afterEach } from 'vitest';
import { DataProcessor } from './DataProcessor.js';
import type { Config, ChatRecord } from '@rdmind/rdmind-core';
import type {
  InsightData,
  SessionFacets,
...
import { read as readJsonlFile } from '@rdmind/rdmind-core';
      ...
      const facets: SessionFacets[] = [
        {
          ...
          rdmind_helpfulness: 'very_helpful',
        ...
        },
        {
          ...
          rdmind_helpfulness: 'moderately_helpful',
    ...
    it('should aggregate primary success excluding none', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          user_satisfaction_counts: {},
          rdmind_helpfulness: 'slightly_helpful',
