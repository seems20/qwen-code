 ...
 * All UI components are now imported from @rdmind/webui
 */
...
import type { BaseToolCallProps } from '@rdmind/webui';
...
export type { BaseToolCallProps, ToolCallData } from '@rdmind/webui';
