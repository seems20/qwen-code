...
export const focusChatCommand = 'rdmind-code.focusChat';
export const newConversationCommand = 'rdmind-code.newConversation';
export const showLogsCommand = 'rdmind-code.showLogs';
