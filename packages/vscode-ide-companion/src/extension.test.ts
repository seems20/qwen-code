...
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
} from '@rdmind/rdmind-core/src/ide/detect-ide.js';

vi.mock('@rdmind/rdmind-core/src/ide/detect-ide.js', async () => {
  const actual = await vi.importActual(
    '@rdmind/rdmind-core/src/ide/detect-ide.js',
  );
  return {
    ...actual,
...
describe('activate', () => {
  ...
  it('should register webview view providers for sidebar and secondary positions', async () => {
    ...
    expect(viewIds).toContain('rdmind-code.chatView.sidebar');
    expect(viewIds).toContain('rdmind-code.chatView.secondary');
  });
