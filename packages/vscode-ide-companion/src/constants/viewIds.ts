 ...
 * `rdmind-code:doesNotSupportSecondarySidebar` context key in package.json.
 ...
 */
export const CHAT_VIEW_ID_SIDEBAR = 'rdmind-code.chatView.sidebar';
export const CHAT_VIEW_ID_SECONDARY = 'rdmind-code.chatView.secondary';
