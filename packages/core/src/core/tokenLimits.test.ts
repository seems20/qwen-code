...
describe('tokenLimit', () => {
  describe('Google Gemini', () => {
    ...
    it('should return the correct limit for Gemini 3 Pro and Flash', () => {
      expect(tokenLimit('gemini-3-pro')).toBe(1000000);
      expect(tokenLimit('gemini-3-flash')).toBe(1000000);
      expect(tokenLimit('gemini-3.1-pro-preview')).toBe(1000000);
      expect(tokenLimit('gemini-3.1-flash-preview')).toBe(1000000);
    });
  });
  ...
  describe('Anthropic Claude', () => {
    ...
    it('should return the correct limit for Claude Opus 4.5', () => {
      expect(tokenLimit('claude-opus-4-5@20251101')).toBe(200000);
    });
  ...
  describe('Alibaba Qwen', () => {
    ...
    it('should return the correct limit for glm-5', () => {
      expect(tokenLimit('glm-5')).toBe(202752);
    });
    it('should return the correct output limit for glm-5', () => {
