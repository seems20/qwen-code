...
describe('GeminiContentGenerator Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    generator = new GeminiContentGenerator(mockContentGeneratorConfig, mockConfig);
  ...
  describe('generateContentStream', () => {
    ...
    it('should handle model without thinking level suffix', async () => {
      ...
      expect(requestBody.generationConfig?.thinkingConfig?.thinkingLevel).toBe('THINKING_LEVEL_UNSPECIFIED');
    });
  });
});