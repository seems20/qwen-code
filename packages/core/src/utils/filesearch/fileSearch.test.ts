...
describe('FileSearch', () => {
  ...
  it('should use .rdmindignore rules', async () => {
    ...
    expect(results).toEqual(['src/', '.rdmindignore', 'src/not-ignored.js']);
  });

  it('should combine .gitignore and .rdmindignore rules', async () => {
    tmpDir = await createTmpDir({
      '.gitignore': 'dist/',
      '.rdmindignore': 'build/',
