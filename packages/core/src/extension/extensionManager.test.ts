...
describe('extension tests', () => {
  ...
  describe('loadExtension', () => {
    ...
    it('should load context file path when RDMind.md is present', async () => {
      createExtension({
        extensionsDir: userExtensionsDir,
        name: 'ext1',
        version: '1.0.0',
      ...
      expect(ext1?.contextFiles).toEqual([
        path.join(userExtensionsDir, 'ext1', 'RDMind.md'),
      ]);
    ...
    it('should use default RDMind.md when contextFileName is empty array', async () => {
      ...
      fs.writeFileSync(path.join(extDir, 'RDMind.md'), 'context content');
      ...
      expect(ext?.contextFiles).toEqual([
        path.join(userExtensionsDir, 'ext-empty-context', 'RDMind.md'),
      ]);
    });
