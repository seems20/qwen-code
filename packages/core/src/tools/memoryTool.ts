  ...
  parametersJsonSchema: {
    ...
    properties: {
      ...
      scope: {
        type: 'string',
        description:
          'Where to save the memory: "global" saves to user-level ~/.rdmind/RDMind.md (shared across all projects), "project" saves to current project\'s RDMind.md (project-specific). If not specified, will prompt user to choose.',
        enum: ['global', 'project'],
      },
    },
    required: ['fact'],
...
- \`scope\` (string, optional): Where to save the memory:
  - "global": Saves to user-level ~/.rdmind/RDMind.md (shared across all projects)
  - "project": Saves to current project's RDMind.md (project-specific)
...
// It defaults to include both RDMind.md and AGENTS.md but can be overridden by setGeminiMdFilename.
// RDMind.md is first to maintain backward compatibility (used by /init command and save_memory tool).
