package com.xiaohongshu.rdmind.cli.session;
...
import com.xiaohongshu.rdmind.cli.protocol.data.Capabilities;
import com.xiaohongshu.rdmind.cli.protocol.data.PermissionMode;
import com.xiaohongshu.rdmind.cli.protocol.message.SDKResultMessage;
import com.xiaohongshu.rdmind.cli.protocol.message.SDKSystemMessage;
import com.xiaohongshu.rdmind.cli.protocol.message.SDKUserMessage;
import com.xiaohongshu.rdmind.cli.protocol.message.assistant.SDKAssistantMessage;
import com.xiaohongshu.rdmind.cli.protocol.message.assistant.SDKPartialAssistantMessage;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.CLIControlInitializeRequest;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.CLIControlInitializeResponse;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.CLIControlInterruptRequest;
import com.xiaohongshu.rdmind.cli.protocol.message.control.CLIControlRequest;
import com.xiaohongshu.rdmind.cli.protocol.message.control.CLIControlResponse;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.CLIControlSetModelRequest;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.CLIControlSetPermissionModeRequest;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.ControlRequestPayload;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.ControlResponsePayload;
import com.xiaohongshu.rdmind.cli.session.event.consumers.SessionEventConsumers;
import com.xiaohongshu.rdmind.cli.session.exception.SessionControlException;
import com.xiaohongshu.rdmind.cli.session.exception.SessionSendPromptException;
import com.xiaohongshu.rdmind.cli.transport.Transport;
import com.xiaohongshu.rdmind.cli.transport.TransportOptions;
import com.xiaohongshu.rdmind.cli.utils.MyConcurrentUtils;
...
/**
 * Manages a session with the RDMind CLI, handling communication, sending prompts, and processing responses.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class Session {
     ...
     * @throws com.xiaohongshu.rdmind.cli.session.exception.SessionControlException if the transport is not available
     */
     ...
     *
     * @throws com.xiaohongshu.rdmind.cli.session.exception.SessionControlException if initialization fails
     */
     ...
     *
     * @throws com.xiaohongshu.rdmind.cli.session.exception.SessionControlException if closing fails
     */
     ...
     * @throws com.xiaohongshu.rdmind.cli.session.exception.SessionControlException if the operation fails
     */
     ...
     * @throws com.xiaohongshu.rdmind.cli.session.exception.SessionSendPromptException if sending the prompt fails
     * @throws com.xiaohongshu.rdmind.cli.session.exception.SessionControlException if a control operation fails
     */
