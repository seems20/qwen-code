package com.xiaohongshu.rdmind.cli.session.event.consumers;

import java.util.List;
import java.util.Optional;

import com.xiaohongshu.rdmind.cli.protocol.data.AssistantContent;
import com.xiaohongshu.rdmind.cli.protocol.data.AssistantContent.TextAssistantContent;
import com.xiaohongshu.rdmind.cli.protocol.data.AssistantContent.ThingkingAssistantContent;
import com.xiaohongshu.rdmind.cli.protocol.data.AssistantContent.ToolResultAssistantContent;
import com.xiaohongshu.rdmind.cli.protocol.data.AssistantContent.ToolUseAssistantContent;
import com.xiaohongshu.rdmind.cli.protocol.data.AssistantUsage;
import com.xiaohongshu.rdmind.cli.protocol.data.behavior.Allow;
import com.xiaohongshu.rdmind.cli.protocol.data.behavior.Behavior;
...
import com.xiaohongshu.rdmind.cli.protocol.message.assistant.block.ContentBlock;
import com.xiaohongshu.rdmind.cli.protocol.message.assistant.event.ContentBlockDeltaEvent;
import com.xiaohongshu.rdmind.cli.protocol.message.assistant.event.StreamEvent;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.CLIControlPermissionRequest;
import com.xiaohongshu.rdmind.cli.protocol.message.control.payload.CLIControlPermissionResponse;
...
public class SessionEventSimpleConsumers implements SessionEventConsumers {
     ...
     *
     * @param session a {@link com.xiaohongshu.rdmind.cli.session.Session} object.
     * @param assistantContent a {@link com.xiaohongshu.rdmind.cli.protocol.data.AssistantContent} object.
     */
