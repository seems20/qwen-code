package com.xiaohongshu.rdmind.cli.example;
...
import com.xiaohongshu.rdmind.cli.protocol.data.behavior.Behavior.Operation;
...
import com.xiaohongshu.rdmind.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void main(String[] args) {
        Session session = RDMindCli.newSession();
        try {
