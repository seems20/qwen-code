package com.xiaohongshu.rdmind.acp;
...
import com.xiaohongshu.rdmind.acp.protocol.agent.response.InitializeResponse;
...
import com.xiaohongshu.rdmind.acp.protocol.agent.response.LoadSessionResponse;
import com.xiaohongshu.rdmind.acp.protocol.agent.response.NewSessionResponse;
import com.xiaohongshu.rdmind.acp.protocol.domain.content.block.ContentBlock;
import com.xiaohongshu.rdmind.acp.session.Session;
import com.xiaohongshu.rdmind.acp.session.event.consumer.AgentEventConsumer;
import com.xiaohongshu.rdmind.acp.session.exception.SessionLoadException;
...
import com.xiaohongshu.rdmind.acp.utils.TransportUtils;
 ...
 * @version 0.0.1
 */
public class RDMindAcpClient {
    private final Transport transport;
    private Session session;
    private static final Logger logger = LoggerFactory.getLogger(RDMindAcpClient.class);
     ...
     */
    public RDMindAcpClient(Transport transport) throws AgentInitializeException {
     ...
     * @throws AgentInitializeException Thrown when an error occurs during initialization
     */
    public RDMindAcpClient(Transport transport, InitializeRequestParams initializeRequestParams) throws AgentInitializeException {
