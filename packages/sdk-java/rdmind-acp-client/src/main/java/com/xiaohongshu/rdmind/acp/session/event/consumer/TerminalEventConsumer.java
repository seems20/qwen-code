...
import com.xiaohongshu.rdmind.acp.protocol.client.response.terminal.CreateTerminalResponse.CreateTerminalResponseResult;
import com.xiaohongshu.rdmind.acp.protocol.client.response.terminal.KillTerminalCommandResponse.KillTerminalCommandResponseResult;
import com.xiaohongshu.rdmind.acp.protocol.client.response.terminal.ReleaseTerminalResponse.ReleaseTerminalResponseResult;
import com.xiaohongshu.rdmind.acp.protocol.client.response.terminal.TerminalOutputResponse.TerminalOutputResponseResult;
import com.xiaohongshu.rdmind.acp.protocol.client.response.terminal.WaitForTerminalExitResponse.WaitForTerminalExitResponseResult;
