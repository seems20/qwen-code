...
import com.xiaohongshu.rdmind.acp.protocol.domain.agent.AgentCapabilities;
import com.xiaohongshu.rdmind.acp.protocol.domain.agent.AgentInfo;
import com.xiaohongshu.rdmind.acp.protocol.domain.agent.AuthMethod;
import com.xiaohongshu.rdmind.acp.protocol.jsonrpc.Response;

import static com.xiaohongshu.rdmind.acp.protocol.agent.response.InitializeResponse.InitializeResponseResult;
