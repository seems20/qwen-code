...
class SessionTest {
    ...
    void partialSendPromptSuccessfully() throws SessionControlException, SessionSendPromptException {
        Session session = RDMindCli.newSession(new TransportOptions().setIncludePartialMessages(true));
    ...
    void setPermissionModeSuccessfully() throws SessionControlException, SessionSendPromptException {
        Session session = RDMindCli.newSession(new TransportOptions());
    ...
    void testJSON() {
        String json
                ...
                + " RDMind SDK for Java today?\",\"type\":\"text\"}],\"id\":\"ed8374fe-a4eb-4fc0-9780-9bd2fd831cda\","
