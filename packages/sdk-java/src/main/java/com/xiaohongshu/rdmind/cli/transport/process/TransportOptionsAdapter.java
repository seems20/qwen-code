...
class TransportOptionsAdapter {
    ...
    String[] buildCommandArgs() {
        List<String> args = new ArrayList<>(
                Arrays.asList(transportOptions.getPathToRDMindExecutable(), "--input-format", "stream-json", "--output-format",
    ...
    private TransportOptions addDefaultTransportOptions(TransportOptions userTransportOptions) {
        ...
        if (StringUtils.isBlank(transportOptions.getPathToRDMindExecutable())) {
            transportOptions.setPathToRDMindExecutable("rdmind");
        }
