...
import com.xiaohongshu.rdmind.cli.session.event.consumers.AssistantContentConsumers;
...
import com.xiaohongshu.rdmind.cli.transport.process.ProcessTransport;
...
/**
 * Main entry point for interacting with the RDMind CLI. Provides static methods for simple queries and session management.
 *
 * @author skyfire
 * @version $Id: 0.0.1
 */
public class RDMindCli {
    private static final Logger log = LoggerFactory.getLogger(RDMindCli.class);

    /**
     * Sends a simple query to the RDMind CLI and returns a list of responses.
     *
