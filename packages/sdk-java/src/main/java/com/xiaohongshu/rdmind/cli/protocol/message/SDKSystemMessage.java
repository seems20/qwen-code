package com.xiaohongshu.rdmind.cli.protocol.message;
...
public class SDKSystemMessage extends MessageBase {
     ...
     * RDMind version.
     */
    @JSONField(name = "rdmind_version")
    private String rdmindVersion;
    /**
     * Output style.
     */
    ...
    /**
     * Gets the RDMind version.
     *
     * @return The RDMind version
     */
    public String getRdmindVersion() {
        return rdmindVersion;
    }

    /**
     * Sets the RDMind version.
     *
     * @param rdmindVersion The RDMind version
     */
    public void setRdmindVersion(String rdmindVersion) {
        this.rdmindVersion = rdmindVersion;
    }
