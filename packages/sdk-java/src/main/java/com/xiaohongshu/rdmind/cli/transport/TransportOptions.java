...
public class TransportOptions implements Cloneable {
    /**
     * Path to the RDMind executable.
     */
    private String pathToRDMindExecutable;
    /**
    ...
    /**
     * Gets the path to the RDMind executable.
     *
     * @return The path to the RDMind executable
     */
    public String getPathToRDMindExecutable() {
        return pathToRDMindExecutable;
    }

    /**
     * Sets the path to the RDMind executable.
     *
     * @param pathToRDMindExecutable The path to the RDMind executable
     * @return This instance for method chaining
     */
    public TransportOptions setPathToRDMindExecutable(String pathToRDMindExecutable) {
        this.pathToRDMindExecutable = pathToRDMindExecutable;
        return this;
    }
