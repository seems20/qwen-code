...
const USER_GEMINI_DIR = path.join(os.homedir(), '.rdmind');
// Project-level .gemini directory in the workspace
const WORKSPACE_GEMINI_DIR = path.join(projectRoot, '.rdmind');

// Telemetry artifacts are stored in a hashed directory under the user's ~/.rdmind/tmp
